 ...
 */
public class ShortContest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_short_contest, container, false);
        db = new DatabaseHandler(getContext());
        recycleLayout = view.findViewById(R.id.short_recycler);
        Constants c = new Constants();
        arrayList = new ArrayList<>();
        arrayList = db.getAllEvents(c.SHORT);
